...
inline btScalar	calculateCombinedRollingFriction(btScalar rollingFriction0, btScalar rollingFriction1)
{
	//Syncronize implementation(code inside function)
	//with calculateCombinedRollingFriction() in BulletCollision/CollisionDispatch/btManifoldResult.cpp
	btScalar friction = rollingFriction0 * rollingFriction1;
...
inline btScalar	calculateCombinedRestitution(btScalar restitution0,btScalar restitution1)
{
 ...
 void	SpuContactResult::setContactInfo(btPersistentManifold* spuManifold, ppu_address_t	manifoldAddress,const btTransform& worldTrans0,const btTransform& worldTrans1, btScalar restitution0,btScalar restitution1, btScalar friction0,btScalar friction1, btScalar rollingFriction0,btScalar rollingFriction1, bool isSwapped)
 {
	...
	m_combinedRollingFriction = calculateCombinedRollingFriction(rollingFriction0,rollingFriction1);
...
bool ManifoldResultAddContactPoint(const btVector3& normalOnBInWorld,
								   ...
								   btTransform& transB,
									...
									btScalar	combinedRollingFriction,
								   bool isSwapped)
{
...
//	float contactTreshold = manifoldPtr->getContactBreakingThreshold();
	...
	newPt.m_combinedRollingFriction = combinedRollingFriction;
