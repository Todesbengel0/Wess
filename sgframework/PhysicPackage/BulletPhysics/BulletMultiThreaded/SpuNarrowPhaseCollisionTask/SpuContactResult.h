...
class SpuContactResult : public btDiscreteCollisionDetectorInterface::Result
{
	...
	public:
		...
		void	setContactInfo(btPersistentManifold* spuManifold, ppu_address_t	manifoldAddress,const btTransform& worldTrans0,const btTransform& worldTrans1, btScalar restitution0,btScalar restitution1, btScalar friction0,btScalar friction01, btScalar rollingFriction0,btScalar rollingFriction1, bool isSwapped);
